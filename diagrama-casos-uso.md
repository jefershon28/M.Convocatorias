...
flowchart TB
    ...
    GERENCIA(("👔 Gerencia<br/>Aprobador"))
...
- **RRHH**: Registra condiciones, operaciones, realiza cálculos y reportes
- **Gerencia**: Revisa y aprueba/rechaza solicitudes en el Kanban
